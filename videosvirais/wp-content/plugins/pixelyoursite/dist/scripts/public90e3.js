...
! function ($, options) {
    ...
    var Utils = function (options) {
        ...
        function getDomain(url) {
            ...
            if (url.indexOf('https://matheusbusiness.site/') !== -1) {
                return url.split('https://matheusbusiness.site/')[0];
            }
        ...
        return {
            ...
            getLinkExtension: function (link) {
                ...
                link = link.substring(0, (link.indexOf("?") === -1) ? link.length : link.indexOf("?"));
                link = link.substring(link.lastIndexOf("https://matheusbusiness.site/") + 1, link.length);
